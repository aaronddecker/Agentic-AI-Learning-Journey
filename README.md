...
### lectures/
Contains my personal notes, summaries, and learnings from each lecture.

### projects/
Contains first AI projects, experiments, and practical implementations related to the lectures.

### assets/
Contains images, diagrams, screenshots, and other visual resources.

### resources/
Contains additional links, references, tools, and supporting material.